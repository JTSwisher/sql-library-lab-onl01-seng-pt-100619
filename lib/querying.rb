...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM series JOIN series ON characters.series_id = series.id WHERE characters.species = 'human' group by series_id order by count(*) desc limit 1;"
end
